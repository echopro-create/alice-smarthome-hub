...
Если у вас нет выделенного сервера Home Assistant, но вы хотите управлять устройствами Яндекса через технику Apple (приложение «Дом» и Siri), то более простым решением будет [настройка проброса устройств Яндекса в Apple HomeKit через Homebridge](/troubleshooting/yandex-alice-homebridge). А для тех, кто предпочитает визуальное программирование логики без разворачивания тяжеловесной HA, отличной альтернативой послужит [настройка Node-RED с Умным Домом Яндекса](/scenarios/nodered-yandex-setup).
