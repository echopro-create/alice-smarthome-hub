...
Если датчики продолжают отваливаться без видимых причин, рекомендуется проверить, не сталкивается ли ваша сеть с общим переполнением координатора. Об этом детально рассказано в материале про [ошибку «Устройство не отвечает»](/troubleshooting/device-not-responding).
