...
Чтобы защитить конфигурацию вашей системы от сбоев оборудования, настройте [автоматическое резервное копирование Home Assistant на Яндекс Диск](/scenarios/ha-supervisor-backups).
