...
Для решения проблем с общением со Станцией ночью воспользуйтесь руководством по исправлению ошибок, если [Алиса шепчет слишком тихо или не распознает шепот](/troubleshooting/alice-whisper-mode-issues).
