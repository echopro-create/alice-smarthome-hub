...
Если ваши беспроводные устройства часто отключаются, изучите причины, [почему батарейка в датчике Zigbee быстро разряжается](/troubleshooting/battery-drain-zigbee), или воспользуйтесь инструкцией, [как заново спарить и настроить датчик Zigbee без потери истории графиков](/troubleshooting/zigbee-sensor-reset).
