...
В результате задержка выполнения команды вырастает до нескольких секунд, а в приложении Яндекса часто возникает ошибка [«Устройство не отвечает»](/troubleshooting/device-not-responding). Перед тем как приступать к отладке сложных сетевых проблем, рекомендуем ознакомиться с базовым руководством по [подключению и настройке устройств Tuya в Доме с Алисой](/scenarios/tuya-devices-to-yandex).
...
Облачные сессии Tuya имеют свойство устаревать. При возникновении ошибок авторизации или проблем с обнаружением новых устройств обратитесь к нашему руководству по [устранению ошибок авторизации и привязки навыка Tuya](/troubleshooting/tuya-skill-linking-error). Чтобы автоматика не отключилась в самый неподходящий момент, также изучите инструкцию по [борьбе с отвалами авторизации навыка Tuya](/troubleshooting/tuya-skill-token-expired).
