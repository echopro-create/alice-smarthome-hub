...
steps:
  - title: "Подготовка медиаплеера на сервере HA"
    text: "Убедитесь, что ваш медиаплеер (например, ресивер Denon или телевизор LG) настроен на стороне HA, управляется из интерфейса и имеет актуальные статусы."
