...
Для загородных домов автоматизация обогрева критически важна для защиты коммуникаций. Если вы настраиваете отопление на даче, изучите наше руководство по [сценарию предотвращения замерзания дома](/scenarios/cottage-freeze-prevention) в зимний период. Подобная логика сбережения ресурсов и автоматического контроля также применяется в сценариях кухни, например, при [автоматическом запуске чайника по датчику движения](/scenarios/smart-kettle-morning). Для комплексного покомнатного контроля температуры также полезно изучить [настройку Zigbee-термоголовок с Алисой](/scenarios/smart-thermostats-yandex).
