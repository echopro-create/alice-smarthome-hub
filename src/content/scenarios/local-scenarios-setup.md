...
Чтобы правильно спроектировать автономную систему, изучите, [какие устройства работают локально без интернета в Доме с Алисой](/scenarios/yandex-devices-without-cloud), а также гайд по [резервному питанию для роутера, хаба и Станции при отключении 220В](/scenarios/uninterruptible-power-smart-home).
