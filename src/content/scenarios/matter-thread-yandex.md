...
Индустрия умного дома переживает фундаментальный сдвиг с переходом на открытые стандарты **Matter** и **Thread**. Яндекс активно поддерживает это направление: Станции второго поколения, Миди и Макс аппаратно оснащены чипами, способными работать с этими протоколами.
