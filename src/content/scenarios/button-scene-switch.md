...
Кроме того, на беспроводную кнопку можно привязать [гостевой режим](/scenarios/guest-mode-override) для отключения автоматических сценариев или использовать [голосовые команды активаторы](/scenarios/voice-activation-rules).
