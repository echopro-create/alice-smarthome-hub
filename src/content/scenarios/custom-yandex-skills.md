...
Для обеспечения безопасного проброса кастомных навыков разберитесь с [настройкой Nginx Proxy Manager для HA](/scenarios/ha-proxy-nginx-ssl) и [использованием DuckDNS для бесплатного SSL-сертификата в HA](/scenarios/ha-duckdns-setup).
