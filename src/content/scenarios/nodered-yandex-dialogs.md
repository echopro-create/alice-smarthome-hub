...
> [!NOTE]
> Чтобы начать использовать эти возможности, необходимо связать обе платформы. Прежде чем переходить к созданию сложных сценариев, обязательно выполните [базовую настройку Node-RED для работы с Алисой](/scenarios/nodered-yandex-setup), включая обеспечение удаленного доступа к вашему серверу и авторизацию.
...
Для реализации еще более нестандартного голосового управления ознакомьтесь с руководством по [созданию приватных навыков Алисы](/scenarios/custom-yandex-skills).
