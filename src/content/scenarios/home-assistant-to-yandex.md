...
> [!NOTE]
> Для критически важных систем, работающих без подключения к глобальной сети, рекомендуется настроить [локальный проброс Home Assistant в Яндекс](/scenarios/homeassistant-local-control), который функционирует внутри домашней сети по протоколу HomeKit без отправки трафика на внешние сервера.
...
Если вам нужно подключить датчики к серверу HA напрямую, изучите инструкцию по [прошивке Zigbee-стика Sonoff 3.0](/scenarios/zigbee-dongle-flashing).
