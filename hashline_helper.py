# Утилита построчного хэширования файлов (MD5).
# Используется для отслеживания изменений контента по строкам —
# помогает сравнивать версии статей при массовом ревью контента.
# Usage: python hashline_helper.py <filepath>
